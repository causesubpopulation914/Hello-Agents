...
1. Select "Create New Project" from the main menu.
2. Enter a name for your agent.
3. Choose a folder on your computer where the agent saves its work.
4. Input your AI service key if the screen prompts you to do so. This key allows the software to connect to the brain of the agent.
5. Click "Initialize" to build the foundation of your agent.
...
2. Select "Upload Files" to pick documents from your computer.
3. Wait for the green status bar, which indicates the agent read your file.
4. Ask your agent a question related to the uploaded content.
